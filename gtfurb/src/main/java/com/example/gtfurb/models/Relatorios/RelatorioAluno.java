...
public class RelatorioAluno {
    ...
    @ManyToOne
    @JoinColumn(name = "id_aluno", nullable = false, foreignKey = @ForeignKey(name = "fk_relatorioAluno_aluno"))
    private Aluno aluno;

    @ManyToOne
    @JoinColumn(name = "id_relatorio", nullable = false, foreignKey = @ForeignKey(name = "fk_relatorioAluno_relatorio"))
